            ...
            <div class="lg:grid lg:grid-cols-12 lg:gap-8">
                ...
                <div class="lg:col-span-6">
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <a href="https://www.instagram.com/hmikomisariatpnj/" target="_blank" class="social-icon youtube">
                            <svg role="img" width="20" class="fill-current" viewBox="0 0 24 24"
                                xmlns="http://www.w3.org/2000/svg">
                                <title>YouTube</title>
                                <path
                        ...
                        <a href="https://www.instagram.com/hmikomisariatpnj/" target="_blank" class="social-icon tiktok">
                            <svg role="img" width="20" class="fill-current" viewBox="0 0 24 24"
                                xmlns="http://www.w3.org/2000/svg">
                                <title>TikTok</title>
                                <path
