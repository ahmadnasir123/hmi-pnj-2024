...
<main class="min-h-screen">
        ...
        <div class="relative px-4 mx-auto max-w-7xl lg:px-14 lg:py-16">
            <div class="lg:grid lg:grid-cols-12 lg:gap-8">
                ...
                <div class="lg:col-span-6">
                    ...
                    <p class="mb-6 text-lg text-[#AFAEC3]">Ayok ikuti saya di social media yang lain</p>
                    <div class="flex items-center space-x-4">
                        <a href="https://www.instagram.com/hmikomisariatpnj/" target="_blank" class="social-icon instagram">
                        ...
                        <a href="https://youtube.com/ahmad nasir" target="_blank" class="social-icon youtube">
                            <svg role="img" width="20" class="fill-current" viewBox="0 0 24 24"
                                xmlns="http://www.w3.org/2000/svg">
                                <title>YouTube</title>
                                <path
                        ...
                        <a href="https://linkedin.com/ahmad nasir" target="_blank" class="social-icon linkedin">
                            <svg role="img" width="20" class="fill-current" viewBox="0 0 24 24"
                                xmlns="http://www.w3.org/2000/svg">
                                <title>LinkedIn</title>
                                <path
                                    d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.139.921-2.063 2.063-2.063 1.14 0 2.062.926 2.062 2.063 0 1.139-.921 2.065-2.062 2.065zm1.778 13.019H3.56V9h3.555v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.226.792 24 1.771 24h20.451C23.206 24 24 23.226 24 22.271V1.729C24 .774 23.206 0 22.225 0z" />
                            </svg>
                        </a>
                        <a href="https://tiktok.com/@asir_35" target="_blank" class="social-icon tiktok">
                            <svg role="img" width="20" class="fill-current" viewBox="0 0 24 24"
                                xmlns="http://www.w3.org/2000/svg">
                                <title>TikTok</title>
                                <path
    ...
    <section id="pengurus" class="mt-4 lg:mt-16 ">
        <div class="px-4 mx-auto max-w-7xl lg:px-14 py-14">
            ...
            <p class="text-[#A7B0B5] mt-2">Pengurus HMI Komisariat PNJ Tahun {{ \Carbon\Carbon::now()->format('Y') }}</p>
...
<style>
    ...
    #contact {
        margin-top: 3rem; /* 12 for default margin top */
    }
    @media (min-width: 1024px) {
    #contact {
        margin-top: 6rem; /* 24 for larger screens */
    }
    }
