    ...
    <div class="content-wrapper">
        ...
        <div class="content-header row">
            <div class="mb-2 content-header-left col-md-6 col-12 breadcrumb-new">
                <h3 class="mb-0 content-header-title d-inline-block">Edit Kegiatan</h3>
                        ...
                        <div class="card">
                            ...
                            <div class="card-content collpase show">
                                <div class="card-body">
                                    ...
                                    <form class="form form-horizontal" action="{{ route("backsite.documantation.update", [$documantation->id]) }}" method="POST"
                                        ...
                                        <div class="form-body">
                                            ...
                                            <h4 class="form-section"><i class="fa fa-edit"></i> Form Kegiatan</h4>

                                            <div class="form-group row">
                                                <label class="col-md-3 label-control" for="name">Nama Kegiatan <code
                                                        style="color:red;">required</code></label>
                                                <div class="mx-auto col-md-9">
                                                    <input type="text" id="name" name="name" class="form-control"
                                                        placeholder="example Bukber 2024"
                                                        value="{{ old('name', isset($documantation) ? $documantation->name : '') }}"
                                        ...
                                        <div class="text-right form-actions">
                                            <a href="{{ route('backsite.documantation.index') }}" style="width:120px;"
