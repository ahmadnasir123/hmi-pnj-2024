    ...
    <div class="content-wrapper">
        ...
        <div class="content-header row">
            <div class="mb-2 content-header-left col-md-6 col-12 breadcrumb-new">
                <h3 class="mb-0 content-header-title d-inline-block">Alumni</h3>
                        ...
                        <div class="card">
                            ...
                            <div class="card-content collapse hide">
                                <div class="card-body card-dashboard">
                                    ...
                                    <form class="form form-horizontal" action="{{ route('backsite.alumni.store') }}"
                                        ...
                                        <div class="form-body">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="mx-auto col-md-9">
                                                    <input type="text" id="name" name="name" class="form-control" placeholder="example john doe or jane doe"
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="mx-auto col-md-9">
                                                    <input type="text" id="angkatan" name="angkatan" class="form-control" placeholder="2014"
                            ...
                            <div class="card-body card-dashboard">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered text-inputs-searching default-table">
                                        ...
                                        <tbody>
                                            @forelse($alumni as $key => $alumni_item)
                                            <tr data-entry-id="{{ $alumni_item->id }}">
                                                <td>{{ isset($alumni_item->created_at) ? date("d/m/Y
                                                    H:i:s",strtotime($alumni_item->created_at)) : '' }}</td>
                                                <td>{{ $alumni_item->name ?? '' }}</td>
                                                <td>{{ $alumni_item->angkatan ?? '' }}</td>
                                                <td>
                                                    @if($alumni_item->photo)
                                                    <a data-fancybox="gallery"
                                                        href="{{ asset('storage/' . $alumni_item->photo) }}"
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <div class="mb-1 mr-1 btn-group">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            ...
                                                            @can('alumni_show')
                                                            <a href="#mymodal"
                                                                data-remote="{{ route('backsite.alumni.show', $alumni_item->id) }}"
                                                                data-toggle="modal" data-target="#mymodal"
                                                                data-title="Alumni Detail" class="dropdown-item">
                                                                Show
                                                            </a>
                                                            @endcan
                                                            ...
                                                            <a class="dropdown-item"
                                                                href="{{ route('backsite.alumni.edit', $alumni_item->id) }}">
                                                                Edit
                                                            </a>
                                                            @endcan
                                                            ...
                                                            @can('alumni_delete')
                                                            <form
                                                                action="{{ route('backsite.alumni.destroy', $alumni_item->id) }}"
                                                                method="POST"
