    ...
    <div class="content-wrapper">
        ...
        <div class="content-header row">
            <div class="mb-2 content-header-left col-md-6 col-12 breadcrumb-new">
                <h3 class="mb-0 content-header-title d-inline-block">Edit Role</h3>
                                                ...
                                                <div class="mx-auto col-md-9">
                                                    ...
                                                    <select name="permission[]" id="permission"
                                                        ...
                                                        <option value="{{ $permission_item->id }}" {{
                                                            (in_array($permission_item->id, old('permission', [])) ||
                                                            isset($role) &&
                                                            $role->permission->contains($permission_item->id)) ?
                                                            'selected' : '' }}>{{ $permission_item->title }}</option>
                                                        @endforeach
                                                    </select>
