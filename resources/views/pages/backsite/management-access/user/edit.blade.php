    ...
    <div class="content-wrapper">
        ...
        <div class="content-header row">
            <div class="mb-2 content-header-left col-md-6 col-12 breadcrumb-new">
                <h3 class="mb-0 content-header-title d-inline-block">Edit User</h3>
                        ...
                        <div class="card">
                            ...
                            <div class="card-content collpase show">
                                <div class="card-body">
                                    ...
                                    <form class="form form-horizontal" action="{{ route("backsite.user.update",
                                        [$user->id]) }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-body">
                                            ...
                                            <div class="form-group row {{ $errors->has('role') ? 'has-error' : '' }}">
                                                ...
                                                <div class="mx-auto col-md-9">
                                                    <label for="role">
                                                        <span class="select-all btn btn-warning btn-sm">{{ 'Select all'
                                                            }}</span>
                                                        <span class="btn btn-warning btn-sm deselect-all">{{ 'Deselect
                                                            all' }}</span>
                                                    </label>
                                                    ...
                                                    <select name="role[]" id="role"
                                                        ...
                                                        <option value="{{ $id }}" {{ (in_array($id, old('role', [])) ||
                                                            (isset($user) && $user->role->contains($id))) ?
                                                            'selected' : '' }}>
                                                            {{ $role }}
                                                        </option>
                                                        @endforeach
                                            ...
                                            <div
                                                ...
                                                <div class="mx-auto col-md-9">
                                                    <select name="type_user_id" id="type_user_id"
                                                        ...
                                                        <option value="{{ $type_user_item->id }}" {{ (isset($user->
                                                            detail_user) && $type_user_item->id ==
                                                            $user->detail_user->type_user_id) ? 'selected' : '' }}>
                                                            {{ $type_user_item->name }}
                                                        </option>
                                                        @endforeach
                                                    </select>
